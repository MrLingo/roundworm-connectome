...
void MainWindow::on_pushButton_clicked()
{
    ...
    if (startingPosition <= 25 && startingPosition >= 1 ){
        ...
        // Worm sense oxygen
         ...
         Neuron neuron9("AFDR", "Unknown", 1);
         Neuron neuron10("AIAL", "Unknown", 1);

         Neuron neuron11("AFDR", "Acetycholine", 1);
         Neuron neuron12("AIAL", "Acetycholine", 1);
         Neuron neuron13("AIAR", "Unknown", 1);
         Neuron neuron14("AIBL", "Unknown", 1);
         Neuron neuron15("AIBR", "Serotonin", 2);
         Neuron neuron16("AIML", "Serotonin", 2);
         Neuron neuron17("AIMR", "Glutamate", 1);
         Neuron neuron18("AINL", "Glutamate", 1);
         Neuron neuron19("AINR", "Acetycholine", 1);
         Neuron neuron20("AIYL", "Acetycholine", 1);
         ...
         Neuron neuron26("ALNL", "Acetycholine", 1);
         Neuron neuron27("ALNR", "Acetycholine", 1);
         Neuron neuron28("AQR", "Unknown", 1);
         Neuron neuron29("AS1", "Acetycholine", 1);
         Neuron neuron30("AS10", "Acetycholine", 1);
         ...
         Neuron neuron36("AS6", "Acetycholine", 1);
         Neuron neuron37("AS7", "Acetycholine", 1);
         Neuron neuron38("AS8", "Unknown", 1);
         Neuron neuron39("AS9", "Acetycholine", 1);
         Neuron neuron40("ASEL", "Acetycholine", 1);
         ...
         Neuron neuron89("DA1", "Acetycholine", 1);
         Neuron neuron90("DA2", "Acetycholine", 1);

         Neuron neuron91("DA3", "Acetycholine", 1);
         Neuron neuron92("DA4", "Acetycholine", 1);
         Neuron neuron93("DA5", "Acetycholine", 1);
         Neuron neuron94("DA6", "Acetycholine", 1);
         Neuron neuron95("DA7", "Acetycholine", 1);
         Neuron neuron96("DA8", "Acetycholine", 1);
         Neuron neuron97("DA9", "Acetycholine", 1);
         Neuron neuron98("DB1", "Acetycholine", 1);
         Neuron neuron99("DB2", "Acetycholine", 1);
         Neuron neuron100("DB3", "Acetycholine", 1);

         Neuron neuron101("DB4", "Acetycholine", 1);
         Neuron neuron102("DB5", "Acetycholine", 1);
         Neuron neuron103("DB6", "Acetycholine", 1);
         Neuron neuron104("DB7", "Acetycholine", 1);
         ...
         Neuron neuron116("HSNL", "Serotonin/Acetycholine", 3);
         Neuron neuron117("HSNR", "Serotonin/Acetycholine", 3);
         Neuron neuron118("I1L", "Acetycholine", 1);
         Neuron neuron119("I1R", "Acetycholine", 1);
         ...
         Neuron neuron125("I6", "Acetycholine", 1);
         ...
         Neuron neuron134("IL2L", "Acetycholine", 1);
         Neuron neuron135("IL2R", "Acetycholine", 1);
         ...
         Neuron neuron140("M1", "Acetycholine", 1);

         Neuron neuron141("M2L", "Acetycholine", 1);
         Neuron neuron142("M2R", "Acetycholine", 1);
         Neuron neuron143("M3L", "Glutamate", 1);
         Neuron neuron144("M3R", "Glutamate", 1);
         Neuron neuron145("M4", "Acetycholine", 1);
         Neuron neuron146("M5", "Acetycholine", 1);
         Neuron neuron147("MCL", "Acetycholine", 1);
         Neuron neuron148("MCR", "Acetycholine", 1);
         ...
         Neuron neuron170("PLNL", "Acetycholine", 1);

         Neuron neuron171("PLNR", "Acetycholine", 1);
         ...
         Neuron neuron212("RMDVL", "Acetycholine", 1);
         Neuron neuron213("RMDVR", "Acetycholine", 1);
         ...
         Neuron neuron222("RMHL", "Acetycholine", 1);
         Neuron neuron223("RMHR", "Acetycholine", 1);
         ...
         Neuron neuron232("SDQR", "Acetycholine", 1);
         Neuron neuron233("SIADL", "Acetycholine", 1);
         Neuron neuron234("SIADR", "Acetycholine", 1);
         Neuron neuron235("SIAVL", "Acetycholine", 1);
         Neuron neuron236("SIAVR", "Acetycholine", 1);
         Neuron neuron237("SIBDL", "Acetycholine", 1);
         Neuron neuron238("SIBDR", "Acetycholine", 1);
         Neuron neuron239("SIBVL", "Acetycholine", 1);
         Neuron neuron240("SIBVR", "Acetycholine", 1);

         Neuron neuron241("SMBDL", "Acetylcholine", 1);
         Neuron neuron242("SMBDR", "Acetycholine", 1);
         Neuron neuron243("SMBVL", "Acetycholine", 1);
         Neuron neuron244("SMBVR", "Acetycholine", 1);
         Neuron neuron245("SMDDL", "Acetycholine", 1);
         Neuron neuron246("SMDDR", "Acetycholine", 1);
         Neuron neuron247("SMDVL", "Acetycholine", 1);
         Neuron neuron248("SMDVR", "Acetycholine", 1);
         Neuron neuron249("URADL", "Acetycholine", 1);
         Neuron neuron250("URADR", "Acetycholine", 1);

         Neuron neuron251("URAVL", "Acetylcholine", 1);
         Neuron neuron252("URAVR", "Acetycholine", 1);
         Neuron neuron253("URBL", "Acetycholine", 1);
         Neuron neuron254("URBR", "Acetycholine", 1);
         ...
         Neuron neuron262("VA10", "Acetycholine", 1);
         Neuron neuron263("VA11", "Acetycholine", 1);
         Neuron neuron264("VA12", "Acetycholine", 1);
         Neuron neuron265("VA2", "Acetycholine", 1);
         Neuron neuron266("VA3", "Acetycholine", 1);
         Neuron neuron267("VA4", "Acetycholine", 1);
         Neuron neuron268("VA5", "Acetycholine", 1);
         Neuron neuron269("VA6", "Acetycholine", 1);
         Neuron neuron270("VA7", "Acetycholine", 1);

         Neuron neuron271("VA8", "Acetylcholine", 1);
         Neuron neuron272("VA9", "Acetycholine", 1);
         Neuron neuron273("VB1", "Acetycholine", 1);
         Neuron neuron274("VB10", "Acetycholine", 1);
         Neuron neuron275("VB11", "Acetycholine", 1);
         Neuron neuron276("VB2", "Acetycholine", 1);
         Neuron neuron277("VB3", "Acetycholine", 1);
         Neuron neuron278("VB4", "Acetycholine", 1);
         Neuron neuron279("VB5", "Acetycholine", 1);
         Neuron neuron280("VB6", "Acetycholine", 1);

         Neuron neuron281("VB7", "Acetylcholine", 1);
         Neuron neuron282("VB8", "Acetycholine", 1);
         Neuron neuron283("VB9", "Acetycholine", 1);
         Neuron neuron284("VC1", "Serotonin/Acetycholine", 3);
         Neuron neuron285("VC2", "Serotonin/Acetycholine", 3);
         Neuron neuron286("VC3", "Serotonin/Acetycholine", 3);
         Neuron neuron287("VC4", "Serotonin/Acetycholine", 3);
         Neuron neuron288("VC5", "Serotonin/Acetycholine", 3);
         Neuron neuron289("VC6", "Serotonin/Acetycholine", 3);
         ...
         string displayStr;
         //for (unsigned long long i = 0; i < result[0].getDendrites().size(); i++){
         //             tempStr += "Neuron: " + result[0].getName() + " have dendrite: " + result[0].getDendrites()[i].getName() + "\n";
         //}
